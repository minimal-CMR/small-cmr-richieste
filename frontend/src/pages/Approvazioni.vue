...
const Inner = defineComponent({
  ...
  setup() {
    ...
    watch(() => [filters.value.da, filters.value.a], () => fetchAllBookings(filters.value.da, filters.value.a), { immediate: true });
    ...
    return {
      STATI, STATO_LABELS, STATO_COLORS, STATO_TEXT, statoStyle,
      filters, selectedUser, exportIds, selectedBookingIds, bulkStato,
      filteredUsers, userBookings, calendarRefreshTrigger,
      getStatiForUser, handleBulkStato, handleSingleStato, handleExportCSV,
      toggleBooking, toggleExport,
    };
  },
  template: `
    <div class="page">
